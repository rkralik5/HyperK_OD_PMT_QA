...
The PMT stands are fully 3D-printed, made out of black PLA plastic. 

\subsection{Power supply and readout}

\subsection{Signal-Voltage splitter}
The Signal-Voltage splitters (referred to just as splitters) were produced by Akimichi Taketa (University of Tokyo). Their design is the same as used in PMT measurements at Kamioka in 2025.
